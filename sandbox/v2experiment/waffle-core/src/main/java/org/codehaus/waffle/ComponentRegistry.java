...
public class ComponentRegistry {
     ...
     */
    public ComponentRegistry(ServletContext servletContext) {
     ...
     */
    public static Class<?> locateComponentClass(Object key, Class<?> defaultClass, ServletContext servletContext) throws WaffleException {
